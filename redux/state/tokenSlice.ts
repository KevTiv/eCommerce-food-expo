...
export const { googleOAuthToken, jwtAccessToken, jwtRefreshToken } = tokenSlice.actions
export const getGoogleOAuthToken = (state: RootState) => state.token.googleOAuthResponse.accessToken
export const getJwtAccessToken = (state: RootState) => state.token.tokenJWT.access_token
export const getJwtRefreshToken = (state: RootState) => state.token.tokenJWT.refresh_token
